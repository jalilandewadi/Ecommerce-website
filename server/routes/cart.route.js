...
//@route POST /api/cart/
//@desc add a product in a cart for guest or logged in user
//@access public
router.post("/", async (req, res) => {
  ...
  try {
    ...
    if (cart) {
      ...
      //Create a new cart for guest for user
  ...
  try {
    ...
    if (guestCart) {
      ...
      if (userCart) {
        ...
        // If the user has no cart assign the guest cart to user
